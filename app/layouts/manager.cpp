    ...
    if (layouts.size() > 0) {
        ...
        KMessageBox::createKMessageBox(dialog,
                                       ...
                                       i18np("<b>Multiple Layouts based on Activities</b> mode did not close properly during the last session.<br/><br/>The following layout <b>[ %2 ]</b> had to be updated for consistency!",
                                             "<b>Multiple Layouts based on Activities</b> mode did not close properly during the last session.<br/><br/>The following layouts <b>[ %3 ]</b> had to be updated for consistency!",
                                             layouts.count(),
                                             layouts[0],
                                             layouts.join(", ")),
                                       QStringList(),
